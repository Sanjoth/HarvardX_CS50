...
function addMarker(place)
{
    ...
    // Create marker with label object using Google Maps API
	...
	.done(function(data, textStatus, jqXHR) 
	{
	    ...
	    if (data.length === 0)
	    {
		showInfo(marker, "Slow news day :D");
	    }
	    // Else show news in Unordered List
	    else
	    {
		var ul = "<ul>";	
...
function configure()
{
    ...
    },
    {
        ...
        templates: {
            ...
            suggestion: _.template("<p><b><%- place_name %></b>,<%- admin_name1 %>, <i><%- postal_code %></i></p>")
        }
    });
